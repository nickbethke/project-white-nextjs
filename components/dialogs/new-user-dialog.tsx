    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>This will create a new user.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      When this is checked, an activation token will be
                      generated and sent to the user&apos;s email, so that the
                      user has to activate their account before they can log in.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
